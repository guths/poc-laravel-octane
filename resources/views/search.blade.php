...
<div>
    <table>
        ...
        @foreach($logs as $log)
            <tr>
                <td>{{$log['textPayload'] ?? null}}</td>
                <td>{{$log['labels']['env'] ?? null}} </td>
                <td>{{$log['labels']['logContent'] ?? null}}</td>
                <td>{{$log['labels']['line'] ?? null}}</td>
                <td>{{$log['labels']['merchant_id'] ?? null}}</td>
                <td>{{$log['labels']['level'] ?? null}}</td>
                <td>{{$log['labels']['user_id'] ?? null}}</td>
                <td>{{$log['labels']['class'] ?? null}}</td>
            </tr>
        @endforeach
    </table>
